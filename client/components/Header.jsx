      ...
      <div className="flex flex-col gap-3 lg:grid lg:grid-cols-[24%_62%_14%] xl:grid-cols-[20%_66%_14%] lg:items-end lg:gap-3 xl:gap-4">
        ...
        <div className="w-full">
          <input
            ...
            className="w-full py-2 px-4 lg:py-2.5 lg:px-5 xl:py-3 xl:px-6 rounded-xl border border-[var(--border)] bg-[var(--bg)] text-[var(--text)] text-sm sm:text-base placeholder-[var(--muted-text)] focus:outline-none focus:ring-1 focus:ring-[var(--darker-border)] transition"
          />
        </div>
